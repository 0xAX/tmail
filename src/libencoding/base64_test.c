...
{
	char *test_1 = "a";
	base64_data_t *result_test_1 = base64_encode(test_1, 1);
	printf("result_test_encoding_1 %s\n", result_test_1->data);

	char *test_2 = "ab";
	base64_data_t *result_test_2 = base64_encode(test_2, 2);
	printf("result_test_encoding_2 %s\n", result_test_2->data);

	char *test_3 = "abc";
	base64_data_t *result_test_3 = base64_encode(test_3, 3);
	printf("result_test_encoding_3 %s\n", result_test_3->data);

	char *test_4 = "abcd";
	base64_data_t *result_test_4 = base64_encode(test_4, 4);
	...
	base64_data_t *result_test_5 = base64_encode(test_5, strlen(test_5));
