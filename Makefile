...
$(DEFAULT_TARGET): $(BUILD_LIBS_TARGET) $(BUILD_APPS_TARGET)
	@cd $(SRC_DIR) && $(MAKE) $(MAKE_FLAGS) $(TMAIL_EXECUTABLE) TOPDIR=$(TOPDIR)

$(BUILD_APPS_TARGET): $(BUILD_LIBS_TARGET)
	@cd $(APPS_DIR) && $(MAKE) $(MAKE_FLAGS) $(DEFAULT_TARGET) TOPDIR=$(TOPDIR)
...
$(INSTALL_TARGET): $(BUILD_LIBS_TARGET) $(BUILD_APPS_TARGET)
	@$(INSTALL) $(TMAIL_EXECUTABLE) $(BIN_DIR)
	@$(INSTALL) $(APPS_DIR)/$(SMTP_CAPS_EXECUTABLE) $(BIN_DIR)
...
$(CLEAN_TARGET):
	...
	@cd $(APPS_DIR) && $(MAKE) $(MAKE_FLAGS) $(CLEAN_TARGET) TOPDIR=$(TOPDIR)
